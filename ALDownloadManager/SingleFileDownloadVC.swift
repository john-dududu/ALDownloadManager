...
class SingleFileDownloadVC: UIViewController{
    ...
    func inputUrl() {
        let alertVC = UIAlertController(title: "新建下载任务", message: nil, preferredStyle: .alert)
    ...
    func alTip() {
        let alertVC = UIAlertController(title: "请勿重复下载", message: nil, preferredStyle: .alert)
